...
export default function RegisterPage() {
    return (
        <div className='container mx-auto mt-5 mb-5'>
            <h1 className="font-bold text-3xl text-green-600 text-center mb-5">Register Page</h1>
            ...
            <form className="max-w-sm mx-auto">
                ...
                <div className="flex items-start mb-5">
                    ...
                    <label htmlFor="terms" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Tôi đồng ý với <a href="#" className="text-blue-600 hover:underline dark:text-blue-500">các điều khoản & điều kiện</a></label>
                </div>
                <button type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Đăng ký tài khoản mới</button>
            </form>
        </div>
    )
}
