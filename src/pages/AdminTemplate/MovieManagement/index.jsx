...
export default function MovieManagement() {
    ...
    useEffect(() => {
        const getMovies = async () => {
            try {
                const response = await api.get("/QuanLyPhim/LayDanhSachPhimPhanTrang?maNhom=GP01&soTrang=1&soPhanTuTrenTrang=30");
    ...
    return (
        <div className='container mx-auto'>
            ...
            <div className='flex items-center justify-between'>
                ...
                <button type="button" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800" onClick={handleAddMovie}>
                    Add movie
                </button>
            </div>
